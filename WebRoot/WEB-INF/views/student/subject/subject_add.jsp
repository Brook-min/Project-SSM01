...
<div class="page-container">
    <div class="container-fluid">
        <form class="form-horizontal" id="subject_add">
            <div class="row">
                <div
                        class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="c-red">*&nbsp;</span>&nbsp;&nbsp;科目名称:&nbsp;</span>
...
<script src="static/plugins/pagejs/student/subject/subject_add.js"></script>
<!--[if lt IE 10]>
