            ...
            <div class="row">
                <div
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="${resource.id }"
                               placeholder="编号" name="id" readonly="readonly"/>
                    </div>
                </div>
                <div
                ...
                <div
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="${resource.url}"
                ...
                <div
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="icon" id="icon"
                               value="${resource.icon }" readonly="readonly">
                    </div>
                ...
                <div
                    ...
                    <div class="input-group">
                        ...
                        <input id="resourcecode" name="resourcecode" type="text" value="${resource.resourcecode }"
                               class="form-control" placeholder="资源code"/>
...
<script src="static/plugins/pagejs/system/resource/resource_edit.js"></script>
<!--[if lt IE 10]>
