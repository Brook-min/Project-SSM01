...
<div class="page-container">
    <div class="container-fluid">
        <form class="form-horizontal" id="base_add" method="post">
            <div class="row">
                <div
                    ...
                    <div class="input-group">
							...
							</span> <input type="text" class="form-control" placeholder="名称"
                                           name="name"/>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 input-margin-bottom">
                    <div class="input-group">
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.flag) {
                        ...
                        //清空表单数据和状态
                        $("#base_add").data('bootstrapValidator').resetForm();
                    }
                }
            });
        });
