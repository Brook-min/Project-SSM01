...
<head>
    ...
    <link rel="stylesheet" href="static/plugins/css/validate/bootstrapValidator.css"/>
...
<div class="page-container">
    <div class="container-fluid">
        <form class="form-horizontal" method="post" id="dept_update">
            <div class="row">
                <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom form-group">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" value="${dept.id }" id="id" placeholder="编号" name="id"
                               readonly="readonly"/>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom input-margin-bottom  form-group">
                    <div class="input-group ">
							...
							</span> <input type="text" value="${dept.deptname }" class="form-control" placeholder="部门名称"
                ...
                <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="${dept.address }" placeholder="地址" name="address"
                               id="address"/>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom "
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="icon" id="icon" value="${dept.icon }" readonly>
                    </div>
                ...
                <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                    <div class="input-group">
                        ...
                        <!-- 部门编号 -->
                        <input id="pid" name="pid" value="${dept.pid }" type="hidden">
                    </div>
                    <div id="menuContent">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 mt-20 input-margin-bottom">
                    <div class="input-group">
                        ...
                        <textarea rows="4" class="form-control" name="description"
                                  placeholder="描述">${dept.description}</textarea>
                    </div>
                </div>
            </div>
            <div class="text-r mt-50 " style="display: block; ">
                <div class="tooltip-demo" style="position:absolute;bottom: 10;right:10;">
...
<![endif]-->
<script type="text/javascript" src="static/plugins/pagejs/system/dept/dept_edit.js"></script>
</html>