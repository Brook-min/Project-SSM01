...
<nav class="breadcrumb">
    ...
    市场管理 <span class="c-gray en">&gt;</span>数据备案查询<a
...
<div class="page-container">
    <c:if
            test="${fn:contains(userSession.resourceList, 'market_keepon_query:select')}">
                ...
                <div class="row">
                    <fieldset>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                            <div class="input-group">
                                <span class="input-group-addon">姓名备注: </span> <input
                                    type="text" class="form-control" name="nameRemark" id="nameRemark"
                                    placeholder="姓名备注"/>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                            ...
                            <%-- <c:if test="${fn:contains(userSession.roleCodes, 'Consulting')}"> --%>
                        <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                            <div class="input-group">
                        ...
                        <c:if test="${fn:contains(userSession.roleCodes, 'Marketing')}">
                            <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                                <div class="input-group">
    ...
    <div id="boolbar">
        <c:if
                test="${fn:contains(userSession.resourceList, 'market_keepon_query:consultation')}">
            <a href="javascript:;"
               onclick="assign('学员咨询','market_keepon/selectToSultation')"
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#keeponTable").bootstrapTable({
            ...
            url: "market_keepon/selectConsultationKeepon", //获取数据的Servlet地址
    ...
    function fmtStudentName(value, row, index) {
        if ($.canConsultation) {
            return "<a class='btn btn-link' href='market_keepon/selectToSultation?id="
    ...
    function toConsultation(value) {
        if ($.canConsultation) {
            return "<a class='btn btn-white'  href='market_keepon/selectToSultation?id="
                + value + "' title='咨询'>咨询</a>";
        } else {
            return "";
        }
