...
<nav class="breadcrumb">
    ...
    咨询管理 <span class="c-gray en">&gt;</span>添加咨询信息<a
...
<div class="page-container">
    <form class="form-horizontal" id="consultationForm">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <fieldset>
                    ...
                    <div class="col-sm-5 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">回访时间:</span><input type="text"
                                                                               class="form-control date"
                                                                               readonly="readonly"
                                                                               placeholder="回访时间"
                                                                               name="remindtime"/><span
                    ...
                    <div class="col-sm-5 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">上门时间:</span><input type="text"
                                                                               class="form-control date"
                                                                               readonly="readonly"
                                                                               placeholder="预计上门时间"
                                                                               name="visitdate"/><span
        ...
        <div class="text-center mt-30">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-white"
                                        href="javascript:window.history.go(-1);" target="_blank"><i
    ...
    <fieldset>
        ...
        <table class="table table-bordered table-hover"
               ...
               data-undefined-text=" " id="keeponWithConsultation" style="word-break:break-all; word-wrap:break-all;">
            <thead>
            <tr>
                ...
                <th data-field="content" class="text-c" data-formatter="fmtInformation">咨询信息</th>
                ...
                success: function (result) {
                    if (result.flag) {
                        ...
                        setTimeout(function () {
                            ...
                            /* window.location.href = "consultation/keepon/query/select"; */
                        }, 1200);
