...
<div class="page-container">
    <form class="form-horizontal" id="keeponform">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">咨&nbsp;询&nbsp;师:&nbsp;&nbsp;</span><input
                                ...
                                value="${consultantObj.consultationperson}" class="form-control"
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">咨询时间:</span><input type="text"
                                                                               class="form-control" readonly="readonly"
                                                                               value="<fmt:formatDate value='${consultantObj.consultationtime}' pattern='yyyy-MM-dd hh:mm:ss'/>"
                                                                               placeholder="咨询时间"/>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">备&nbsp;案&nbsp;人:&nbsp;&nbsp;</span><input
                                ...
                                value="${consultantObj.keeponperson}" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">备案时间:</span><input type="text"
                                                                               ...
                                                                               placeholder="备案时间" readonly="readonly"/>
                        </div>
                    </div>
                ...
                <fieldset>
                    <legend>请选择市场专员</legend>
                    <div class="col-sm-4 col-md-4 col-lg-3 input-margin-bottom">
                        <div class="input-group">
                            <span class="input-group-addon">市场专员:</span> <select
                                class="form-control" name="marketer">
                            <c:forEach items="${consultant}" var="co">
                                <c:if
                                        test="${consultantObj.consultationperson == co.realname}">
                                    <option value="${co.realname}" selected="selected">${co.realname}</option>
                                </c:if>
                                <c:if
                                        test="${consultantObj.consultationperson != co.realname}">
                                    <option value="${co.realname}">${co.realname}</option>
                                </c:if>
                            </c:forEach>
                        </select>
                        </div>
...
<script type="text/javascript">
    function send() {
        $.ajax({
            type: "post",
            url: "front/keepon/query/updateKeeponMarker?t=" + (new Date()).getTime().toString(),
            dataType: "json",
            data: $("#keeponform").serialize(),
